...
public class SearchPackageListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_package_list_layout);
        ctx=this;
        ...
        search_handler.setSearchListener(new SearchHandler.SearchListener() {
            ...
            public void callback(String search) {
                ...
                if(refreshing==false && !selected_string.trim().equals("")) {
                    new asynctask_get_data("0").execute();
                }
            }
        });
        try {
            if(getIntent().getStringExtra("search_text")!=null)
                selected_string = getIntent().getStringExtra("search_text") ;
            search_handler.search_et.setText(selected_string);
        }catch (Exception e){}
    ...
    public class asynctask_get_data extends NewAsyncTask<Boolean,Boolean,Boolean> {
        ...
        protected Boolean doInBackground(Boolean... params) {
            ...
            String temp=postRequest("14",index);
            if(temp==null)
            {
    ...
    public String postRequest(String num,String index)
    {
        ...
        fb.add("num",num);
        fb.add("id_num",index);
        fb.add("search_text",selected_string);
...
//        if(search_handler.search_et.getText().toString().trim().equals(""))
//            super.onBackPressed();
//        else
//            search_handler.cancel_search();
//    }
