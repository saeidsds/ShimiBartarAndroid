...
import com.multiplatform.adapter.TransactionAdapter;
...
public class MyTransactionListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_transaction_list_layout);
        ctx=this;
        ...
        adapter=new TransactionAdapter(mlist,this);
    ...
    public class asynctask_get_data extends NewAsyncTask<Boolean,Boolean,Boolean> {
        ...
        protected Boolean doInBackground(Boolean... params) {
            ...
            String temp=postRequest("20",index);
            if(temp==null)
            {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            {
                if(mlist.size()==0)
                    show_msg(getString(R.string.no_transaction));
