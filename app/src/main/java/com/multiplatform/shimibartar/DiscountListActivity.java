...
import com.multiplatform.adapter.DiscountAdapter;
...
public class DiscountListActivity extends AppCompatActivity {
    ...
    String webservice="";
    ListView listview;
    LinkedList<DiscountObject> mlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlist=new LinkedList<DiscountObject>();
        adapter=new DiscountAdapter(mlist,this);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                ClipData clip = ClipData.newPlainText("discount", mlist.get(position).discount_code);
                clipboard.setPrimaryClip(clip);
                Toast.makeText(ctx,getString(R.string.discount_code_copied),Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public class asynctask_get_data extends NewAsyncTask<Boolean,Boolean,Boolean> {
        ...
        LinkedList<DiscountObject> temp_list;
        int error=0;
        String index="0";
        ...
        protected Boolean doInBackground(Boolean... params) {
            ...
            temp_list=new LinkedList<DiscountObject>();

            String temp=postRequest("7",index);
            if(temp==null)
            {
            ...
            if(temp!=null && !temp.trim().equals(""))
            {
                ...
                try {
                    ...
                    if(temp_result.trim().equals("true"))
                    {
                        ...
                        try {
                            Parser.get_discount_array(ctx,jArray,temp_list);
                        }catch (Exception e)
                        {}
        ...
        protected void onPostExecute(Boolean result) {
            ...
            {
                if(mlist.size()==0)
                    show_msg(getString(R.string.no_discount_item));
