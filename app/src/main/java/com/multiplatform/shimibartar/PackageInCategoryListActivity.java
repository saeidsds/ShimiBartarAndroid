...
public class PackageInCategoryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.package_in_category_list_layout);
        ctx=this;
        ...
        MultiplatformHelper.animate_arrow_buttom(ctx,findViewById(R.id.arrow_up));
    ...
    public class asynctask_get_data extends NewAsyncTask<Boolean,Boolean,Boolean> {
        ...
        protected Boolean doInBackground(Boolean... params) {
            ...
            String temp=postRequest("13",index);
            if(temp==null)
            {
